<?php
	...
	include $_SERVER['DOCUMENT_ROOT']."/php/RssParser.class.php";
    $rs = new ReadSections();
    $sections = $rs->makeSectionArr();
	$feedlist = new rss('http://www.lissy93.blogspot.com/feeds/posts/default/-/web-dev');
?>
...
<head>
	...
	<title>Articles, Tutorials and Guides | web-dev-school</title>
...
<body class="content-page">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<h2>Web Coding Articles, How-To's and Guides</h2>
				<?php echo $feedlist->display(); ?>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-5">
				<h2>Add</h2>
				<div class="nice-box text-center" style="min-height: 155px;">
					<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
					<!-- AS93 Computing [Responsive] -->
					<ins class="adsbygoogle"
						 style="display:block"
						 data-ad-client="ca-pub-0513771474172316"
						 data-ad-slot="8645998755"
    ...
    <footer>
        <div class="footer-wrapper">
            <p>&#169; <a href="http://aliciasykes.com" target="_blank">Alicia Sykes</a> 2015</p>
        </div>
    </footer>
